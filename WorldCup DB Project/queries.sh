...
echo "$($PSQL "select name from games inner join teams on team_id = winner_id where round = 'Eighth-Final' and year = 2014 union select name from games inner join teams on team_id = opponent_id where round = 'Eighth-Final' and year = 2014;")"
